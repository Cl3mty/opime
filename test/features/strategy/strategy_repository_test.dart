...
import 'package:freenary/features/strategy/strategy_repository.dart';
...
void main() {
  ...
  setUp(() async {
    tempDir = await Directory.systemTemp.createTemp('freenary_strategy_repo_');
  ...
  test('le titre affiché dans listNotes provient de la première ligne non vide', () async {
    final note = await repo.createNote();
  ...
  test('listNotes trie par date de création (id), la plus récente en premier', () async {
