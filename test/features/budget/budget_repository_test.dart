...
import 'package:opime/features/budget/budget_repository.dart';
...
void main() {
  ...
  setUp(() async {
    tempDir = await Directory.systemTemp.createTemp('opime_budget_repo_');
  ...
  BudgetData sampleData() => BudgetData(
    ...
    expenseCategories: [
      BudgetCategory(
        name: 'Logement',
        items: [BudgetItem(id: 'e1', name: 'Loyer', amount: 900)],
      ),
    ],
  ...
  test('updateSnapshot conserve le nom et met à jour les données', () async {
    ...
    final updated = sampleData().copyWith(
      revenues: [BudgetItem(id: 'r1', name: 'Salaire', amount: 4000)],
    );
