...
void main() {
  ...
  setUp(() async {
    tempDir = await Directory.systemTemp.createTemp('opime_academy_repo_');
  ...
  test(
    'read retourne un ensemble vide si rien n\'a jamais été écrit',
    () async {
  ...
  test(
    'un contenu corrompu retombe sur un ensemble vide plutôt que de planter',
    () async {
      await repo.write({'a'});
