...
abstract class AppLocalizations {
  ...
  /// No description provided for @dashboard_personal_wealth_section_title.
  ///
  /// In fr, this message translates to:
  /// **'Patrimoine personnel'**
  String get dashboard_personal_wealth_section_title;
  ...
  /// No description provided for @dashboard_entities_section_title.
  ///
  /// In fr, this message translates to:
  /// **'Patrimoine professionnel'**
  String get dashboard_entities_section_title;
  ...
  /// No description provided for @landing_nav_cta.
  ///
  /// In fr, this message translates to:
  /// **'Ouvrir l\'application'**
  String get landing_nav_cta;

  /// No description provided for @landing_hero_eyebrow.
  ///
  /// In fr, this message translates to:
  /// **'100 % local · Aucun compte requis'**
  String get landing_hero_eyebrow;

  /// No description provided for @landing_hero_title.
  ///
  /// In fr, this message translates to:
  /// **'Ton patrimoine, enfin sous contrôle.'**
  String get landing_hero_title;

  /// No description provided for @landing_hero_subtitle.
  ///
  /// In fr, this message translates to:
  /// **'Opime centralise tes comptes, tes investissements et tes projets financiers dans un seul endroit — sans jamais envoyer tes données ailleurs que sur ton propre appareil.'**
  String get landing_hero_subtitle;

  /// No description provided for @landing_hero_cta_primary.
  ///
  /// In fr, this message translates to:
  /// **'Commencer gratuitement'**
  String get landing_hero_cta_primary;

  /// No description provided for @landing_hero_cta_secondary.
  ///
  /// In fr, this message translates to:
  /// **'Découvrir les fonctionnalités'**
  String get landing_hero_cta_secondary;

  /// No description provided for @landing_features_title.
  ///
  /// In fr, this message translates to:
  /// **'Tout ce qu\'il faut pour piloter tes finances'**
  String get landing_features_title;

  /// No description provided for @landing_features_subtitle.
  ///
  /// In fr, this message translates to:
  /// **'Une seule application, du suivi patrimonial quotidien aux simulations les plus poussées.'**
  String get landing_features_subtitle;

  /// No description provided for @landing_feature_dashboard_title.
  ///
  /// In fr, this message translates to:
  /// **'Dashboard patrimoine'**
  String get landing_feature_dashboard_title;

  /// No description provided for @landing_feature_dashboard_description.
  ///
  /// In fr, this message translates to:
  /// **'Suis en un coup d\'œil l\'évolution de ton patrimoine, tous comptes et avoirs confondus.'**
  String get landing_feature_dashboard_description;

  /// No description provided for @landing_feature_investments_title.
  ///
  /// In fr, this message translates to:
  /// **'Investissements'**
  String get landing_feature_investments_title;

  /// No description provided for @landing_feature_investments_description.
  ///
  /// In fr, this message translates to:
  /// **'Actions, ETF, crypto, immobilier : centralise tes positions et suis leur performance réelle.'**
  String get landing_feature_investments_description;

  /// No description provided for @landing_feature_budget_title.
  ///
  /// In fr, this message translates to:
  /// **'Budget'**
  String get landing_feature_budget_title;

  /// No description provided for @landing_feature_budget_description.
  ///
  /// In fr, this message translates to:
  /// **'Bâtis un budget clair et suis tes dépenses mois après mois.'**
  String get landing_feature_budget_description;

  /// No description provided for @landing_feature_simulations_title.
  ///
  /// In fr, this message translates to:
  /// **'Simulations'**
  String get landing_feature_simulations_title;

  /// No description provided for @landing_feature_simulations_description.
  ///
  /// In fr, this message translates to:
  /// **'Projette ton patrimoine, optimise ta fiscalité, anticipe une transmission.'**
  String get landing_feature_simulations_description;

  /// No description provided for @landing_feature_academy_title.
  ///
  /// In fr, this message translates to:
  /// **'Académie'**
  String get landing_feature_academy_title;

  /// No description provided for @landing_feature_academy_description.
  ///
  /// In fr, this message translates to:
  /// **'Apprends les bases de la gestion de patrimoine à ton rythme, directement dans l\'app.'**
  String get landing_feature_academy_description;

  /// No description provided for @landing_feature_privacy_title.
  ///
  /// In fr, this message translates to:
  /// **'Confidentialité'**
  String get landing_feature_privacy_title;

  /// No description provided for @landing_feature_privacy_description.
  ///
  /// In fr, this message translates to:
  /// **'Tes données restent les tiennes : aucun serveur, aucun tracking, chiffrement optionnel.'**
  String get landing_feature_privacy_description;

  /// No description provided for @landing_stat_data_label.
  ///
  /// In fr, this message translates to:
  /// **'Tes données'**
  String get landing_stat_data_label;

  /// No description provided for @landing_stat_data_description.
  ///
  /// In fr, this message translates to:
  /// **'Stockées chez toi ou sur ton propre cloud — jamais sur nos serveurs.'**
  String get landing_stat_data_description;

  /// No description provided for @landing_stat_free_label.
  ///
  /// In fr, this message translates to:
  /// **'Gratuit'**
  String get landing_stat_free_label;

  /// No description provided for @landing_stat_free_description.
  ///
  /// In fr, this message translates to:
  /// **'Aucun abonnement, aucun palier payant, pour toujours.'**
  String get landing_stat_free_description;

  /// No description provided for @landing_stat_modern_label.
  ///
  /// In fr, this message translates to:
  /// **'Moderne & ergonomique'**
  String get landing_stat_modern_label;

  /// No description provided for @landing_stat_modern_description.
  ///
  /// In fr, this message translates to:
  /// **'Une interface soignée, pensée pour être agréable au quotidien.'**
  String get landing_stat_modern_description;

  /// No description provided for @landing_community_title.
  ///
  /// In fr, this message translates to:
  /// **'Façonne Opime avec moi'**
  String get landing_community_title;

  /// No description provided for @landing_community_subtitle.
  ///
  /// In fr, this message translates to:
  /// **'Opime est open source : propose tes idées et vote pour les prochaines fonctionnalités directement sur GitHub.'**
  String get landing_community_subtitle;

  /// No description provided for @landing_community_cta.
  ///
  /// In fr, this message translates to:
  /// **'Voter pour une fonctionnalité'**
  String get landing_community_cta;

  /// No description provided for @landing_nav_download.
  ///
  /// In fr, this message translates to:
  /// **'Télécharger'**
  String get landing_nav_download;

  /// No description provided for @landing_nav_theme_dark.
  ///
  /// In fr, this message translates to:
  /// **'Sombre'**
  String get landing_nav_theme_dark;

  /// No description provided for @landing_nav_theme_light.
  ///
  /// In fr, this message translates to:
  /// **'Clair'**
  String get landing_nav_theme_light;

  /// No description provided for @landing_download_title.
  ///
  /// In fr, this message translates to:
  /// **'Télécharge Opime pour {os}'**
  String landing_download_title(String os);

  /// No description provided for @landing_download_subtitle.
  ///
  /// In fr, this message translates to:
  /// **'L\'application de bureau, gratuite et open source — tes données restent sur ton disque.'**
  String get landing_download_subtitle;

  /// No description provided for @landing_download_button.
  ///
  /// In fr, this message translates to:
  /// **'Télécharger pour {os}'**
  String landing_download_button(String os);

  /// No description provided for @landing_download_other.
  ///
  /// In fr, this message translates to:
  /// **'ou pour {os}'**
  String landing_download_other(String os);

  /// No description provided for @landing_download_all_versions.
  ///
  /// In fr, this message translates to:
  /// **'Voir toutes les versions sur GitHub'**
  String get landing_download_all_versions;

  /// No description provided for @landing_or_divider.
  ///
  /// In fr, this message translates to:
  /// **'ou'**
  String get landing_or_divider;

  /// No description provided for @landing_final_cta_subtitle.
  ///
  /// In fr, this message translates to:
  /// **'Crée ton coffre-fort en quelques secondes, directement dans ton navigateur.'**
  String get landing_final_cta_subtitle;

  /// No description provided for @landing_final_cta_button.
  ///
  /// In fr, this message translates to:
  /// **'Commencer maintenant'**
  String get landing_final_cta_button;

  /// No description provided for @landing_footer_github.
  ///
  /// In fr, this message translates to:
  /// **'Code source sur GitHub'**
  String get landing_footer_github;

  /// No description provided for @landing_footer_tagline.
  ///
  /// In fr, this message translates to:
  /// **'Opime — gestion de patrimoine locale et open source.'**
  ...
  ///
  /// In fr, this message translates to:
  /// **'Les données privées de ce coffre-fort (comptes, budget, dettes, projets, notes de stratégie, simulations) sont chiffrées. Le mot de passe est redemandé à chaque lancement de l\'app.'**
  ...
  /// No description provided for @shell_loading_vault.
  ///
  /// In fr, this message translates to:
  /// **'Ouverture de ton coffre-fort...'**
  String get shell_loading_vault;

  /// No description provided for @shell_loading_data.
  ///
  /// In fr, this message translates to:
  /// **'Chargement de tes données...'**
  String get shell_loading_data;
  ...
  /// No description provided for @core_ui_web_folder_required_title.
  ///
  /// In fr, this message translates to:
  /// **'Navigateur non compatible'**
  String get core_ui_web_folder_required_title;

  /// No description provided for @core_ui_web_folder_required_detail.
  ///
  /// In fr, this message translates to:
  /// **'Ce navigateur ne permet pas d\'accéder à un vrai dossier de ton ordinateur, nécessaire pour que tes données ne soient jamais stockées uniquement dans le navigateur. Utilise un navigateur compatible comme Chrome, Edge ou Opera.'**
  String get core_ui_web_folder_required_detail;
  ...
  ///
  /// In fr, this message translates to:
  /// **'Ajouter une part de détention'**
  String get entities_add_stake_button;

  /// No description provided for @entities_remove_stake_tooltip.
  ///
  /// In fr, this message translates to:
  /// **'Retirer cette part'**
  String get entities_remove_stake_tooltip;
  ...
  /// No description provided for @entities_stake_direct.
  ///
  /// In fr, this message translates to:
  /// **'{percent} % par vous'**
  String entities_stake_direct(String percent);

  /// No description provided for @entities_stake_via_owner.
  ///
  /// In fr, this message translates to:
  /// **'{percent} % via {owner}'**
  String entities_stake_via_owner(String percent, String owner);
  ...
  /// No description provided for @entities_structure_title.
  ///
  /// In fr, this message translates to:
  /// **'Structure de détention'**
  String get entities_structure_title;

  /// No description provided for @entities_myself_label.
  ///
  /// In fr, this message translates to:
  /// **'Moi-même'**
  String get entities_myself_label;
  ...
  /// No description provided for @entities_owned_companies_section_title.
  ///
  /// In fr, this message translates to:
  /// **'Entreprises détenues'**
  String get entities_owned_companies_section_title;

  /// No description provided for @entities_owned_stake_label.
  ///
  /// In fr, this message translates to:
  /// **'Détenue à {percent} %'**
  String entities_owned_stake_label(String percent);

  /// No description provided for @entities_tab_overview.
  ///
  /// In fr, this message translates to:
  /// **'Aperçu'**
  String get entities_tab_overview;

  /// No description provided for @entities_tab_balance_sheet.
  ///
  /// In fr, this message translates to:
  /// **'Bilan'**
  String get entities_tab_balance_sheet;

  /// No description provided for @entities_balance_sheet_assets_title.
  ///
  /// In fr, this message translates to:
  /// **'Actif'**
  String get entities_balance_sheet_assets_title;

  /// No description provided for @entities_balance_sheet_liabilities_title.
  ///
  /// In fr, this message translates to:
  /// **'Passif'**
  String get entities_balance_sheet_liabilities_title;

  /// No description provided for @entities_balance_sheet_total_assets.
  ///
  /// In fr, this message translates to:
  /// **'Total actif'**
  String get entities_balance_sheet_total_assets;

  /// No description provided for @entities_balance_sheet_total_liabilities.
  ///
  /// In fr, this message translates to:
  /// **'Total passif'**
  String get entities_balance_sheet_total_liabilities;

  /// No description provided for @entities_balance_sheet_fixed_assets_title.
  ///
  /// In fr, this message translates to:
  /// **'Actif immobilisé'**
  String get entities_balance_sheet_fixed_assets_title;

  /// No description provided for @entities_balance_sheet_current_assets_title.
  ///
  /// In fr, this message translates to:
  /// **'Actif circulant'**
  String get entities_balance_sheet_current_assets_title;

  /// No description provided for @entities_balance_sheet_intangible_assets.
  ///
  /// In fr, this message translates to:
  /// **'Immobilisations incorporelles'**
  String get entities_balance_sheet_intangible_assets;

  /// No description provided for @entities_balance_sheet_tangible_assets.
  ///
  /// In fr, this message translates to:
  /// **'Immobilisations corporelles'**
  String get entities_balance_sheet_tangible_assets;

  /// No description provided for @entities_balance_sheet_financial_assets.
  ///
  /// In fr, this message translates to:
  /// **'Immobilisations financières'**
  String get entities_balance_sheet_financial_assets;

  /// No description provided for @entities_balance_sheet_inventory.
  ///
  /// In fr, this message translates to:
  /// **'Stocks'**
  String get entities_balance_sheet_inventory;

  /// No description provided for @entities_balance_sheet_receivables.
  ///
  /// In fr, this message translates to:
  /// **'Créances'**
  String get entities_balance_sheet_receivables;

  /// No description provided for @entities_balance_sheet_marketable_securities.
  ///
  /// In fr, this message translates to:
  /// **'Valeurs mobilières de placement'**
  String get entities_balance_sheet_marketable_securities;

  /// No description provided for @entities_balance_sheet_cash.
  ///
  /// In fr, this message translates to:
  /// **'Disponibilités'**
  String get entities_balance_sheet_cash;

  /// No description provided for @entities_balance_sheet_equity_title.
  ///
  /// In fr, this message translates to:
  /// **'Capitaux propres'**
  String get entities_balance_sheet_equity_title;

  /// No description provided for @entities_balance_sheet_provisions_title.
  ///
  /// In fr, this message translates to:
  /// **'Provisions'**
  String get entities_balance_sheet_provisions_title;

  /// No description provided for @entities_balance_sheet_provisions_line.
  ///
  /// In fr, this message translates to:
  /// **'Provisions pour risques et charges'**
  String get entities_balance_sheet_provisions_line;

  /// No description provided for @entities_balance_sheet_debts_title.
  ///
  /// In fr, this message translates to:
  /// **'Dettes'**
  String get entities_balance_sheet_debts_title;

  /// No description provided for @entities_balance_sheet_financial_debts.
  ///
  /// In fr, this message translates to:
  /// **'Emprunts et dettes financières'**
  String get entities_balance_sheet_financial_debts;

  /// No description provided for @entities_balance_sheet_trade_payables.
  ///
  /// In fr, this message translates to:
  /// **'Dettes fournisseurs'**
  String get entities_balance_sheet_trade_payables;

  /// No description provided for @entities_balance_sheet_tax_and_social_debts.
  ///
  /// In fr, this message translates to:
  /// **'Dettes fiscales et sociales'**
  String get entities_balance_sheet_tax_and_social_debts;

  /// No description provided for @entities_balance_sheet_subtotal_label.
  ///
  /// In fr, this message translates to:
  /// **'Total {section}'**
  String entities_balance_sheet_subtotal_label(String section);
  ...
  ///
  /// In fr, this message translates to:
  /// **'Valeur nette détenue via le patrimoine professionnel'**
  ...
  ///
  /// In fr, this message translates to:
  /// **'Holding, société commerciale, SCI...'**
  ...
  /// No description provided for @investments_wizard_owner_myself_label.
  ///
  /// In fr, this message translates to:
  /// **'Moi-même'**
  String get investments_wizard_owner_myself_label;

  /// No description provided for @investments_wizard_owner_myself_sublabel.
  ///
  /// In fr, this message translates to:
  /// **'Patrimoine personnel'**
  String get investments_wizard_owner_myself_sublabel;
  ...
  /// No description provided for @onboarding_web_local_folder_explainer.
  ///
  /// In fr, this message translates to:
  /// **'Choisis un dossier sur ton ordinateur. S\'il est synchronisé par Google Drive, iCloud Drive ou Dropbox, ton coffre-fort le sera aussi — comme sur l\'app de bureau.'**
  String get onboarding_web_local_folder_explainer;

  /// No description provided for @onboarding_web_local_folder_button.
  ///
  /// In fr, this message translates to:
  /// **'Choisir un dossier...'**
  String get onboarding_web_local_folder_button;

  /// No description provided for @onboarding_local_folder_reauth_title.
  ///
  /// In fr, this message translates to:
  /// **'Accès au dossier requis'**
  String get onboarding_local_folder_reauth_title;

  /// No description provided for @onboarding_local_folder_reauth_description.
  ///
  /// In fr, this message translates to:
  /// **'Pour des raisons de sécurité, ton navigateur redemande une autorisation d\'accès à \"{name}\" à chaque nouvelle session.'**
  String onboarding_local_folder_reauth_description(String name);

  /// No description provided for @onboarding_local_folder_reauth_button.
  ///
  /// In fr, this message translates to:
  /// **'Redonner l\'accès'**
  String get onboarding_local_folder_reauth_button;

  /// No description provided for @onboarding_local_folder_reauth_failed.
  ///
  /// In fr, this message translates to:
  /// **'L\'accès n\'a pas été accordé. Réessaie, ou choisis le bon dossier si le navigateur te le demande.'**
  String get onboarding_local_folder_reauth_failed;
  ...
  ///
  /// In fr, this message translates to:
  /// **'Sélectionnez les avoirs et dettes à inclure dans le PDF.'**
  ...
  ///
  /// In fr, this message translates to:
  /// **'Choisis un mot de passe pour chiffrer les données privées de ce coffre-fort (comptes, budget, dettes, projets, notes de stratégie, simulations). Il te sera redemandé à chaque lancement de l\'app.'**
  ...
  /// No description provided for @simulations_taxation_pfu_mode_unique.
  ///
  /// In fr, this message translates to:
  /// **'Retrait unique'**
  String get simulations_taxation_pfu_mode_unique;

  /// No description provided for @simulations_taxation_pfu_mode_rente.
  ///
  /// In fr, this message translates to:
  /// **'Rente programmée'**
  String get simulations_taxation_pfu_mode_rente;

  /// No description provided for @simulations_taxation_pfu_field_simulation_mode.
  ///
  /// In fr, this message translates to:
  /// **'Type de simulation'**
  String get simulations_taxation_pfu_field_simulation_mode;

  /// No description provided for @simulations_taxation_pfu_rente_only_av.
  ///
  /// In fr, this message translates to:
  /// **'Le mode rente n\'est disponible que pour une assurance-vie.'**
  String get simulations_taxation_pfu_rente_only_av;

  /// No description provided for @simulations_taxation_pfu_field_withdrawal_date.
  ///
  /// In fr, this message translates to:
  /// **'Date du retrait'**
  String get simulations_taxation_pfu_field_withdrawal_date;

  /// No description provided for @simulations_taxation_pfu_field_annual_return.
  ///
  /// In fr, this message translates to:
  /// **'Rendement annuel du capital'**
  String get simulations_taxation_pfu_field_annual_return;

  /// No description provided for @simulations_taxation_pfu_projection_hint.
  ///
  /// In fr, this message translates to:
  /// **'La valeur actuelle est projetée jusqu\'à la date du retrait avec ce rendement annuel.'**
  String get simulations_taxation_pfu_projection_hint;

  /// No description provided for @simulations_taxation_pfu_stat_projected_value.
  ///
  /// In fr, this message translates to:
  /// **'Valeur projetée au retrait'**
  String get simulations_taxation_pfu_stat_projected_value;

  /// No description provided for @simulations_taxation_pfu_field_rente_monthly.
  ///
  /// In fr, this message translates to:
  /// **'Rente mensuelle retirée'**
  String get simulations_taxation_pfu_field_rente_monthly;

  /// No description provided for @simulations_taxation_pfu_field_rente_start_date.
  ///
  /// In fr, this message translates to:
  /// **'Date de début de la rente'**
  String get simulations_taxation_pfu_field_rente_start_date;

  /// No description provided for @simulations_taxation_pfu_field_rente_duration.
  ///
  /// In fr, this message translates to:
  /// **'Durée (années)'**
  String get simulations_taxation_pfu_field_rente_duration;

  /// No description provided for @simulations_taxation_pfu_field_rente_performance.
  ///
  /// In fr, this message translates to:
  /// **'Rendement annuel du capital restant'**
  String get simulations_taxation_pfu_field_rente_performance;

  /// No description provided for @simulations_taxation_pfu_rente_section_title.
  ///
  /// In fr, this message translates to:
  /// **'Rente programmée — Assurance-vie'**
  String get simulations_taxation_pfu_rente_section_title;

  /// No description provided for @simulations_taxation_pfu_rente_abattement_legend.
  ///
  /// In fr, this message translates to:
  /// **'Abattement annuel : 4 600 € (contrat de moins de 8 ans) puis 9 200 € (à partir de 8 ans), appliqué chaque année avant taxation de la part du gain.'**
  String get simulations_taxation_pfu_rente_abattement_legend;

  /// No description provided for @simulations_taxation_pfu_rente_capital_exhausted.
  ///
  /// In fr, this message translates to:
  /// **'{count, plural, =1{La rente s\'arrête après 1 an : le capital est épuisé.} other{La rente s\'arrête après {count} ans : le capital est épuisé.}}'**
  String simulations_taxation_pfu_rente_capital_exhausted(int count);

  /// No description provided for @simulations_taxation_pfu_rente_capital_insufficient.
  ///
  /// In fr, this message translates to:
  /// **'Le capital est insuffisant pour verser une rente de ce montant.'**
  String get simulations_taxation_pfu_rente_capital_insufficient;

  /// No description provided for @simulations_taxation_pfu_rente_assumptions.
  ///
  /// In fr, this message translates to:
  /// **'Hypothèses : la part du gain prélevée dans chaque retrait est supposée constante et le barème progressif de l\'IR n\'est pas comparé dans ce mode.'**
  String get simulations_taxation_pfu_rente_assumptions;

  /// No description provided for @simulations_taxation_pfu_stat_total_withdrawn.
  ///
  /// In fr, this message translates to:
  /// **'Total retiré'**
  String get simulations_taxation_pfu_stat_total_withdrawn;

  /// No description provided for @simulations_taxation_pfu_stat_total_tax.
  ///
  /// In fr, this message translates to:
  /// **'Impôt total (IR + PS)'**
  String get simulations_taxation_pfu_stat_total_tax;

  /// No description provided for @simulations_taxation_pfu_stat_total_net.
  ///
  /// In fr, this message translates to:
  /// **'Total net reçu'**
  String get simulations_taxation_pfu_stat_total_net;

  /// No description provided for @simulations_taxation_pfu_stat_effective_rate.
  ///
  /// In fr, this message translates to:
  /// **'Taux d\'imposition effectif'**
  String get simulations_taxation_pfu_stat_effective_rate;

  /// No description provided for @simulations_taxation_pfu_stat_gain_share.
  ///
  /// In fr, this message translates to:
  /// **'Part du gain dans la rente'**
  String get simulations_taxation_pfu_stat_gain_share;

  /// No description provided for @simulations_taxation_pfu_stat_simulated_years.
  ///
  /// In fr, this message translates to:
  /// **'Années simulées'**
  String get simulations_taxation_pfu_stat_simulated_years;

  /// No description provided for @simulations_taxation_pfu_table_year.
  ///
  /// In fr, this message translates to:
  /// **'Année'**
  String get simulations_taxation_pfu_table_year;

  /// No description provided for @simulations_taxation_pfu_table_contract_age.
  ///
  /// In fr, this message translates to:
  /// **'Âge du contrat'**
  String get simulations_taxation_pfu_table_contract_age;

  /// No description provided for @simulations_taxation_pfu_table_withdrawal.
  ///
  /// In fr, this message translates to:
  /// **'Rente brute'**
  String get simulations_taxation_pfu_table_withdrawal;

  /// No description provided for @simulations_taxation_pfu_table_tax.
  ///
  /// In fr, this message translates to:
  /// **'Impôt PFU'**
  String get simulations_taxation_pfu_table_tax;

  /// No description provided for @simulations_taxation_pfu_table_net.
  ///
  /// In fr, this message translates to:
  /// **'Net reçu'**
  String get simulations_taxation_pfu_table_net;
  ...
  ///
  /// In fr, this message translates to:
  /// **'Corrélation moyenne entre les avoirs de cette catégorie'**
  ...
  ///
  /// In fr, this message translates to:
  /// **'Taux d\'endettement (placements)'**
  String get analyses_debt_ratio_assets_label;

  /// No description provided for @analyses_debt_ratio_assets_tooltip.
  ///
  /// In fr, this message translates to:
  /// **'Dette totale rapportée aux avoirs totaux — plus il est élevé, plus le patrimoine est financé par l\'emprunt.'**
  ...
  ///
  /// In fr, this message translates to:
  /// **'Placements totaux rapportés au patrimoine net — au-dessus de 1, une partie des placements est financée par la dette.'**
