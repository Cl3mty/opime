...
const envelopes = [
  Envelope(
    ...
    pitfall: 'Laisser dormir une épargne de précaution entière sur un compte courant plutôt que sur un Livret A.',
  ),
  Envelope(
    id: 'envelope_livret_a',
    name: 'Livret A',
    level: AcademyLevel.debutant,
    tagline: 'L\'épargne de précaution par excellence, sans risque et sans impôt.',
    ceiling: '22 950 €',
    taxation: 'Intérêts exonérés d\'impôt sur le revenu et de prélèvements sociaux',
    ...
    pitfall: 'Y accumuler bien plus que le nécessaire pour la sécurité, au détriment de placements plus rémunérateurs.',
  ),
  Envelope(
    id: 'envelope_ldds',
    name: 'LDDS',
    level: AcademyLevel.debutant,
    tagline: 'Le cousin du Livret A, orienté vers le financement de l\'économie sociale et solidaire.',
    ceiling: '12 000 €',
    taxation: 'Intérêts exonérés d\'impôt sur le revenu et de prélèvements sociaux',
    liquidity: 'Totale, retrait possible à tout moment sans pénalité',
    ...
    pitfall: 'Ignorer le LDDS en pensant, à tort, qu\'il est moins intéressant que le Livret A : les conditions sont identiques.',
  ),
  Envelope(
    id: 'envelope_lep',
    name: 'LEP',
    level: AcademyLevel.intermediaire,
    tagline: 'Le livret réglementé le plus généreux, réservé aux revenus modestes.',
    ceiling: '10 000 €',
    taxation: 'Intérêts exonérés d\'impôt sur le revenu et de prélèvements sociaux',
    liquidity: 'Totale, retrait possible à tout moment sans pénalité',
    ...
    pitfall: 'Ne pas vérifier son éligibilité chaque année alors que la situation fiscale a changé.',
  ),
  Envelope(
    id: 'envelope_pel',
    name: 'PEL',
    ...
    taxation: 'Intérêts fiscalisés (impôt et prélèvements sociaux), régime variable selon la date d\'ouverture',
    ...
    pitfall: 'Ouvrir un PEL sans projet immobilier réel : son rendement est rarement compétitif comparé à d\'autres enveloppes.',
  ),
  Envelope(
    id: 'envelope_cto',
    name: 'Compte-titres ordinaire (CTO)',
    level: AcademyLevel.intermediaire,
    tagline: 'Le compte le plus flexible pour investir en bourse, sans cadre fiscal privilégié.',
    ceiling: 'Aucun plafond',
    taxation: 'Gains imposés au prélèvement forfaitaire unique de 30 % (ou barème progressif sur option)',
    ...
    pitfall: 'Multiplier les allers-retours (achats/ventes) sans mesurer l\'impact fiscal cumulé de chaque plus-value réalisée.',
  ),
  Envelope(
    id: 'envelope_pea',
    name: 'PEA',
    level: AcademyLevel.avance,
    tagline: 'Investir en actions européennes avec un cadre fiscal avantageux après 5 ans.',
    ceiling: '150 000 €',
    taxation: 'Gains exonérés d\'impôt sur le revenu après 5 ans (prélèvements sociaux toujours dus)',
    liquidity: 'Un retrait avant 5 ans a longtemps entraîné la clôture du plan : vérifier les règles en vigueur',
    ...
    pitfall: 'Retirer des fonds avant 5 ans sans avoir vérifié les conséquences sur la clôture du plan et la fiscalité applicable.',
  ),
  Envelope(
    id: 'envelope_assurance_vie',
    name: 'Assurance-vie',
    level: AcademyLevel.avance,
    tagline: 'Le couteau suisse de l\'épargne française : placement et transmission.',
    ceiling: 'Aucun plafond',
    taxation: 'Fiscalité dégressive avec l\'ancienneté du contrat, nettement plus favorable après 8 ans',
    liquidity: 'Rachats possibles à tout moment, mais moins avantageux fiscalement avant 8 ans',
    ...
    pitfall: 'Clôturer un contrat juste avant son 8ᵉ anniversaire, en perdant l\'abattement fiscal annuel qui s\'active à cette date.',
  ),
  Envelope(
    id: 'envelope_pee_peg',
    name: 'PEE / PEG',
    ...
    ceiling: 'Pas de plafond réglementaire propre (limité par les versements issus de l\'épargne salariale)',
    taxation: 'Plus-values exonérées d\'impôt sur le revenu (prélèvements sociaux dus)',
    liquidity: 'Bloqué 5 ans, sauf cas de déblocage anticipé prévus par la loi',
    idealFor: 'Les salariés dont l\'entreprise propose un dispositif d\'épargne salariale',
    goodToKnow: [
    ...
    pitfall: 'Laisser l\'épargne salariale sur des fonds par défaut peu diversifiés sans jamais vérifier son allocation.',
  ),
  Envelope(
    id: 'envelope_per',
    name: 'PER',
    level: AcademyLevel.avance,
    tagline: 'Préparer sa retraite en réduisant son impôt aujourd\'hui, au prix d\'un blocage long.',
    ceiling: 'Déduction plafonnée à un pourcentage des revenus professionnels (variable selon la situation)',
    taxation: 'Versements déductibles du revenu imposable à l\'entrée, sortie fiscalisée (capital et/ou rente)',
    liquidity: 'Bloqué jusqu\'à la retraite, sauf accidents de la vie ou achat de la résidence principale',
    idealFor: 'Les contribuables fortement imposés qui visent une épargne retraite de long terme',
    goodToKnow: [
    ...
    pitfall: 'Verser sur un PER sans tenir compte du blocage jusqu\'à la retraite ni de la fiscalité à la sortie, qui peut surprendre.',
  ),
];
