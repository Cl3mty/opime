...
class PriceHistoryRepository {
  ...
  VaultFile _fileFor(String isin) =>
      VaultFile(p.join(vaultPath, 'investissements', 'cours', '$isin.json'));

  Future<void> _ensureDir() async {
    final dir = VaultDirectory(p.join(vaultPath, 'investissements', 'cours'));
