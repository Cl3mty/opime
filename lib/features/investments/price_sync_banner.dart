...
class _PriceSyncBannerState extends State<PriceSyncBanner> {
  ...
  Widget build(BuildContext context) {
    // Sur le web, un navigateur bloque par principe les appels directs vers
    // les API de cours (CORS) — `PriceSyncStatusController` bascule alors en
    // permanence sur "hors ligne" même avec une vraie connexion internet, ce
    // qui rendrait ce bandeau quasi toujours affiché et donc trompeur.
    if (kIsWeb || !widget.controller.offline) return widget.child;
