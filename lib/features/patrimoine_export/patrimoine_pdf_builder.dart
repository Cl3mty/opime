...
/// bancaire : synthèse, une table par catégorie d'avoir retenue, une table
/// des dettes retenues. Aucune dépendance à `BuildContext`/Flutter widgets.
library;
...
pw.Widget _buildSummary(PatrimoineExportData data) {
  return pw.Row(
    children: [
      _summaryBox('Total avoirs', data.totalActifs, PdfColors.green700),
      pw.SizedBox(width: 12),
      _summaryBox('Total dettes', data.totalPassifs, PdfColors.red700),
      pw.SizedBox(width: 12),
