...
/// SCI) du profil — même pattern que [LiabilitiesRepository]
...
/// sauvegarde.
///
/// Lu par `dashboard_screen.dart`, quel que soit le coffre-fort, via
/// `entities_patrimoine_adapter.dart`, pour consolider la valeur nette
/// détenue des entités dans le patrimoine global — voir la doc de tête de
/// `entities_models.dart`.
