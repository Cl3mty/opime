...
class TopBar extends StatelessWidget {
  ...
  /// Chevron retour tout à gauche de la barre — `false` le masque plutôt
  /// que de l'afficher désactivé, même principe que le bouton retour de
  /// l'AppBar mobile (voir `AppShell._mobileCanGoBack`).
